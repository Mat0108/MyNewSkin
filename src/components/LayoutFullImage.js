...
const LayoutFullImage =({props})=>{
    return (<>
        <div className="relative w-full h-fit bg-[#DEE4E4]">
            ...
            {props.button && <div className="absolute z-[1000] top-[550px] w-full h-[60px] text-white_coffee text-[50px] flex center"><p className="w-[50%] py-2 bg-blue rounded-3xl">{props.button}</p> </div>}
